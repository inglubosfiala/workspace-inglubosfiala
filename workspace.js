...
cprequire_test(["inline:com-chilipeppr-workspace-inglubosfiala"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-inglubosfiala", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-inglubosfiala", // Make the id the same as the cpdefine id
        name: "Workspace / Sample", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace for testing.`,
